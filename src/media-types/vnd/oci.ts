import type { sbom } from '#src/media-types/sbom'
import { type MediaType, mediaType } from '#src/media-types/t'
import type { helm } from '#src/media-types/vnd/cncf/helm'
import type { notary } from '#src/media-types/vnd/cncf/notary'
import type { cosign } from '#src/media-types/vnd/dev/cosign'
import type { docker } from '#src/media-types/vnd/docker'
import type { inToto } from '#src/media-types/vnd/in-toto'
import type { wasm } from '#src/media-types/vnd/wasm'
